...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-4 offset-lg-3 col-md-4 offset-md-3 col-sm-6 col-12 ">
      <a href="https://uasd.edu.do/" class="is_img journal-name navbar-brand-logo" target="_blank">
        <img class="img-responsive" src="{$baseUrl}/plugins/themes/bootstrap3/templates/images/logo_uasd.png" alt="{translate|escape key="uasd.logo.img-alt"}">
      </a>
    </div>
  </div>
</div>